...
import com.ieseljust.pmdm.contactes.viewmodel.FirstFragmentViewModel
...
class FirstFragment : Fragment(), MyDialogFragment.OkOrCancelDialogable {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        firstFragmentViewModel.contacteClicked.observe(viewLifecycleOwner) { contacte ->
            contacte?.let {
                // Ressetegem el valor del contacteClicked
                firstFragmentViewModel.contacteClicked.value = null
        ...
        firstFragmentViewModel.contacteLongClicked.observe(viewLifecycleOwner) { contacte ->
            contacte?.let {
                // Ressetegem el valor
                firstFragmentViewModel.contacteLongClicked.value = null
    ...
    override fun onPositiveClick() {
        ...
        val contacteToRemove=firstFragmentViewModel.contacteToRemove.value
        firstFragmentViewModel.contacteToRemove.value = null
        ...
        contacteToRemove?.also {
            ...
            firstFragmentViewModel.removeContact(it)
        }
    }
